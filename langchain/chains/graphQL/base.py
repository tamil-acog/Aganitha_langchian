...
class GraphQLChain(Chain, BaseModel):
    ...
    def _call(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        intermediate_steps = []
        graphql_cmd = llm_chain.predict(**llm_inputs)
        intermediate_steps.append(graphql_cmd)
        self.callback_manager.on_text(graphql_cmd, color="green", verbose=self.verbose)
        result = self.database.run(graphql_cmd)
        intermediate_steps.append(result)
        self.callback_manager.on_text("\nGraphQLResult: ", verbose=self.verbose)
    ...
    def _chain_type(self) -> str:
        return "graphql_database_chain"


class GraphQLSequentialChain(Chain, BaseModel):
